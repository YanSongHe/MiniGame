window.utils =
{
    ...
    //判断数字是否在某个范围
    isNumInRange : function(num, maxNum, minNum)
    {
        return (num <= maxNum && num >= minNum);
    },

    //播放序列帧
    runSequenceFrame : function(sprite, spriteFrameList, maxIndex, fpt)
    {
        var index = 0;
    ...
    //二维数组转换为字符串
    getStringFromTDArray : function(tdArray, char1, char2)
    {
        var string = "";
    ...
    getTDArrayFromString : function(string, char1, char2)
    {
        var tdArray = [];
