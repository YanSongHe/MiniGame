...
({
    ...
    onTouchBegan : function(posY, type)
    {
        var touchColumnNum = Math.floor((posY + this.node.height / 2) / gameConfig.stepNum);
        ...
        if(inInColumn)
        {
            ...
            {
                var nodeStar = this.starList[touchColumnNum][n];
                ...
                if(nodeStar != null)
                {
                    ...
                    {
                        isKill= true;
                        this.touchStars(touchColumnNum, n);
                    }
                }
            }
        }
